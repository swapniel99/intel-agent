...
export class OllamaProvider {
  constructor(baseUrl, model, reasoningEffort = "") {
    this.baseUrl = baseUrl.replace(/\/$/, "");
    this.model = model;
    this.reasoningEffort = reasoningEffort; // "low"|"medium"|"high"|""
  }
  ...
  async generateContent(conversationHistory, functionDeclarations, systemInstruction, forceFinish) {
    ...
    if (this.reasoningEffort && message.reasoning) {
      console.group("%c[Ollama Reasoning]", "color:#a5d6ff;font-weight:bold");
